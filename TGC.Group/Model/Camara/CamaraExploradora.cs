...
{
    class CamaraExploradora : TgcCamera
    {
        /// <summary>
        ...
        /// <param name="input"></param>
        public CamaraExploradora(TGCVector3 positionEye, TgcD3dInput input) : this(input)
        {
        ...
        /// <param name="input"></param>
        public CamaraExploradora(TGCVector3 positionEye, float moveSpeed, float jumpSpeed, TgcD3dInput input)
        ...
        /// <param name="input"></param>
        public CamaraExploradora(TGCVector3 positionEye, float moveSpeed, float jumpSpeed, float rotationSpeed, TgcD3dInput input)
