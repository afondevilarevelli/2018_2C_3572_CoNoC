...
namespace TGC.Examples.Camara
{
    ...
    /// </summary>
    public class camaraRotacional : TgcCamera
    {
        ...
        /// </summary>
        public camaraRotacional(TgcD3dInput input)
        {
            Input = input;
        ...
        public camaraRotacional(TGCVector3 position, TGCVector3 target, TgcD3dInput input) : this(input)
        {
            NextPos = position;
            CameraCenter = target;
            base.SetCamera(NextPos, LookAt, UpVector);
        ...
        public camaraRotacional(TGCVector3 cameraCenter, float cameraDistance, float zoomFactor, float rotationSpeed,
            TgcD3dInput input)
            : this(input)
        {
        ...
        /// <param name="cameraDistance"></param>
        /// <param name="zoomFactor"></param>
        public camaraRotacional(TGCVector3 cameraCenter, float cameraDistance, float zoomFactor, TgcD3dInput input) :
        ...
        /// <param name="cameraCenter"></param>
        /// <param name="cameraDistance"></param>
        public camaraRotacional(TGCVector3 cameraCenter, float cameraDistance, TgcD3dInput input) :
