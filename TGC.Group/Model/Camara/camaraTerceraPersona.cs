...
namespace TGC.Group.Camara
{
    ...
    /// </summary>
    public class camaraTerceraPersona : TgcCamera
    {
        ...
        public camaraTerceraPersona(TGCVector3 target, float offsetHeight, float offsetForward) : this()
        {
            Target = target;
        ...
        public camaraTerceraPersona(TGCVector3 target, TGCVector3 targetDisplacement, float offsetHeight, float offsetForward)
            : this()
        {
            Target = target;
